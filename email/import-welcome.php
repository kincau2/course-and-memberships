...
<body>
    <div class="container">
        ...
        <h1>Welcome to the New HKOTA Membership System</h1>
        <!-- Main Content Section -->
        <p>Dear <?php echo $user->last_name.', '. $user->first_name ;?>,</p>
        <p>We are pleased to inform you that your membership with the Hong Kong Occupational
          Therapy Association (HKOTA) has now been successfully migrated to our new membership
          management system. This upgrade will allow us to enhance our services and provide a
          smoother experience for you.</p>

        <p>Your Login ID will be: <?php echo $user->user_email ;?></p>

        <p>To access your account in the new system, please click the link below to set your password:</p>
